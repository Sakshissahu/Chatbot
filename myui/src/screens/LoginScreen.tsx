      ...
      <main className="relative z-10 flex flex-1 items-center justify-center px-5 py-10 sm:py-14">
        ...
        >
          <div className="glass rounded-3xl border border-border p-7 shadow-lift sm:p-9">
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={busy}
                className="focus-ring group mt-1 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-accent px-6 py-3.5 text-[0.98rem] font-semibold text-[hsl(var(--accent-ink))] shadow-soft transition-all hover:brightness-105 hover:shadow-glow active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
              >
          ...
          <p className="mt-5 px-2 text-center text-xs leading-relaxed text-ink-faint">
            Demo sign-in — any details work. Your username personalises the chat; the next step
            picks your knowledge base.
          </p>
        </motion.div>
      </main>
    </div>
